 ...
 */
public class BeeSummerJobDetailed {
    private String sId;
    ...
    public String getJobFairStyle() {
        return jobFairStyle;
    }

    public void setJobFairStyle(String jobFairStyle) {
        this.jobFairStyle = jobFairStyle;
    }

    public String getJiesuanStyle() {
        return jiesuanStyle;
    }
