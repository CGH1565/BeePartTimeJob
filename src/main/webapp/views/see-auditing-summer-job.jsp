            ...
            <form action="" method="post" onsubmit="return false">
                ...
                <table class="table" style="margin-bottom:0px;">
                    ...
                    <%
                        ...
                        //表名
                        String tableName = "bst_auditing_company_summerjob";
                        //联结字符串
                    ...
                    <tr>
                        <td width="5%">薪资水平:</td>
                        <td><input type="text" class="form-controls"  value="<%out.print(rs.getString(10));%>" id="Salary" name="Salary" maxlength="18"
                                               autocomplete="off"/></td>
                    </tr>
                    <tr>
                        <td width="5%">工作地区:</td>
                    ...
                    <tr>
                        <td width="5%">详细地址:</td>
                        <td width="40%"><input type="text" class="form-controls" value="<%out.print(rs.getString(5));%>" id="WorkPlaceName" name="WorkPlaceName" maxlength="18"
                                               autocomplete="off"/></td>
                    </tr>
                    <tr>
                        <td width="5%">工作描述：</td>
                    ...
                    <tr>
                        <td width="5%">联系人:</td>
                        <td width="40%"><input type="text" class="form-controls" id="LinkMan"name="LinkMan" maxlength="18" value="<%out.print(rs.getString(7));%>"
                                               autocomplete="off"/></td>
                    </tr>
                    <tr>
                        <td width="5%">手机号码:</td>
                        <td width="40%"><input type="text" class="form-controls" id="MobilePhone" name="MobilePhone" maxlength="18" value="<%out.print(rs.getString(8));%>"
                                               autocomplete="off"/></td>
                    </tr>
                    <%  } %>
                    </tbody>
...
<script>
    ...
    function updates() {
        ...
        var sId = decodeURI(loc.substr(n2+1, n1-n2));//从=号后面的内容
        ...
        $.ajax({
            url:"/test/auditingUpdateSummerJob",
            type:"POST",
            data:JSON.stringify({sId:sId,companyName:companyName,jobName:jobName,mans:mans,salary:salary,address:address,workPlaceName:workPlaceName,
            ...
            success:function (data) {
                if (data == "true") {
                    alert("添加成功！")
                    window.location.href="/views/auditing-summer-job.jsp";
                } else if (data == "false") {
                    alert("登陆失败，用户名或密码错误！！");
                }
            },
