    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            <form action="" method="post" onsubmit="return false">
                <h1 class="page-header">添加兼职信息</h1>
                <table class="table" style="margin-bottom:0px;">
                    ...
                    <%
                        ...
                        String sql = "SELECT * FROM " +tableName+" WHERE JID="+id;
                    ...
                    <tr>
                        ...
                        <td width="10%">
                            <div class="dropdown">
                                <button class="dropdown-toggle form-controls" data-toggle="dropdown" role="button" id="dLabel"
                                        aria-haspopup="true"
                                        aria-expanded="false" style="width: 173px;height: 34px; display: block;
                                        height: 34px;
                                        padding: 6px 12px;
                                        text-align: left;
                                        font-size: 14px;
                                        ...
                                        border-radius: 4px;"><span id='texts'><%out.print(rs.getString(7));%></span><span class="caret" style="margin-left:75%"></span></button>
                                <ul class="dropdown-menu dropdown-menu-left"  aria-labelledby="dLabel" style="width: 173px" >
                                    <li><a  data-toggle="modal" >日结</a>
                                    </li>
                                    <li><a data-toggle="modal" >周结</a>
                                    </li>
                                    <li><a  data-toggle="modal" >月结</a>
                                    </li>
                                </ul>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td width="5%">工作描述：</td>
                        <td><textarea name="JobDesc" id="JobDesc" maxlength="1000" rows="5" class="form-controls" onkeydown="chkLength(this);" aria-required="true" aria-invalid="false" style="margin: 0px 5px 0px 0px; width: 625px; height: 108px;"><%out.print(rs.getString(10));%></textarea>
            ...
            <div class="modal-footer" style="padding-right:77%">
                <button type="button" class="btn btn-primary" style="margin-right: 10%" onclick="updates()">提交</button>
...
<script>
    ...
    function updates() {
        ...
        var jId = decodeURI(loc.substr(n2+1, n1-n2));//从=号后面的内容
        ...
        var realPay = span.innerText;
        var salaryType =  realPay;
        ...
        $.ajax({
            url:"/test/auditingUpdateJobFair",
            type:"POST",
            data:JSON.stringify({jId:jId,companyName:companyName,jobName:jobName,mans:mans,salaryType:salaryType,salary:salary,address:address,workPlaceName:workPlaceName,
                jobDesc:jobDesc,workTime:workTime,linkMan:linkMan,mobilePhone:mobilePhone,updateDate:updateDate}),
            dataType:"json",
            contentType: "application/json",
            success:function (data) {
                if (data == "true") {
                    alert("添加成功！")
                    window.location.href="/views/auditing-jobfair.jsp";
                } else if (data == "false") {
                    alert("添加失败！");
                }
            },
