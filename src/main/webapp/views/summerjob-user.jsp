                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">性别</span></th>
                            <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">年龄</span></th>
                            <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">学历</span></th>
                            <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">专业</span></th>
                            <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">报名时间</span></th>
                        </tr>
                        </thead>
                        <%
                            ...
                            //表名
                            String tableName = "bst_summerjob_user";
                            //联结字符串
                        ...
                        <tr>
                            ...
                            <td><a rel="<%out.print(rs.getString(1));%>" name="delete">删除</a></td>
                        </tr>
                        <%  } %>
                    </table>
                    <%
