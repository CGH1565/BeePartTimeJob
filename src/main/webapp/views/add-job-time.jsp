            ...
            <form action="" method="post" onsubmit="return false">
                ...
                <table class="table" style="margin-bottom:0px;">
                    ...
                    <tr>
                        ...
                        <td width="40%">
                            <div class="dropdown">
                                <button class="dropdown-toggle" data-toggle="dropdown" role="button" id="dLabel"
                                        aria-haspopup="true"
                                        ...
                                        border-radius: 4px;"><span id='texts'>选择</span><span class="caret" style="margin-left:75%"></span></button >
                    ...
                    <tr>
                        <td width="5%">上班时间：</td>
                        <td width="40%"><input type="text" class="form-controls" id="WorkTime" name="WorkTime" maxlength="50"
                                               autocomplete="off"/></td>
                    </tr>
                    <tr>
                        <td width="5%">联系人:</td>
...
<script>
    ...
    function puts() {
        ...
        $.ajax({
            url:"/test/addJobTime",
            type:"POST",
            data:JSON.stringify({companyName:companyName,jobName:jobName,mans:mans,salaryType:salaryType,salary:salary,address:address,workPlaceName:workPlaceName,
